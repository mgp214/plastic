...
class StringFieldCondition extends StatefulWidget {
  final ValueCondition condition;

  const StringFieldCondition({Key key, @required this.condition})
      : super(key: key);

  @override
  State<StatefulWidget> createState() => StringFieldConditionState();
}

class StringFieldConditionState extends State<StringFieldCondition> {
  ...
  void initState() {
    super.initState();
    _nameController = TextEditingController(text: widget.condition.fieldName);
